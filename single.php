    ...
    <article class="post">
      ...
      <section class="post__section post__body">
        <div class="post__contact">
          <input class="post__contact_button" value="Contact" type="button">
        </div>
        <div class="post__miniature">
          ...
          <div class="post__miniature__arrow">
            <img class="arrow arrow__left"src="<?php echo get_template_directory_uri(); ?>/img/left-arrow.svg" alt="fleche gauche">
            <img class="arrow arrow__right"src="<?php echo get_template_directory_uri(); ?>/img/right-arrow.svg" alt="fleche droite">
        </div>
