<div class="suggest__img__item " id="suggestImgItem1">
                ...
                <div class="suggest__img__info">
                  ...
                  <a href="<?php the_permalink(); ?>">
                    ...
                    <img class="hover__icon suggest__img_fullscreen"src="<?php echo get_template_directory_uri(); ?>/img/icon_fullscreen.svg"  data-id-photo ="<?php echo get_the_id(); ?>" alt="fullscreen icon">
                </div>
